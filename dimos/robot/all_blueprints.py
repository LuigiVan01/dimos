...
all_modules = {
    ...
    "g1-mujoco-skill-container": "dimos.robot.unitree.g1.blueprints.agentic._mujoco_skills.G1MujocoSkillContainer",
    ...
    "simulation-module": "dimos.simulation.manipulators.sim_module.SimulationModule",
